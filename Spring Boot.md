##  Terminal cmds:
1. 1. mvn spring-boot:run     (to run)
...
10. while creating a java class file, use annotations (@RestController)
11. while creating call function, use annotation (@GetMapping("/path")), to store the root path (@RequestMapping("/api/v1/path")
```java
